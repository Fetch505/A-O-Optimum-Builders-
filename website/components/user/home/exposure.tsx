const Exposure = () => {
    return (
        <section className="w-full outerPadding flex flex-col justify-between">
            <div className="w-full rounded-3xl h-full p-4 md:p-8 lg:p-12 flex flex-col md:flex-row gap-8 font-FigtreeRegular">
                ...
                {/* Right content */}
                <div className="w-full md:w-4/6 flex flex-col gap-6 font-base ">
                    
                    {/* Heading + paragraph */}
                    <div>
                        <p className="text-xl md:text-2xl lg:text-4xl text-[#ABABAB] ">
                            ...
                            top-quality remodeling, custom homes,
                            concrete works, and repair projects
                        ...
                        <p className="mt-4 text-xl max-w-3xl text-gray-400 leading-relaxed">
